			<footer class="foot" id="footer">
				<div class="section foot-cont"><a class="foot-title" href="./index.php"><span>Leka.kz</span><span>since 1989</span></a>
					<div class="foot-col foot-nav-col">
						...
						<nav class="foot-nav foot-navigation"><a class="foot-nav-link" href="./product-card.php">Каталог</a><a class="foot-nav-link" href="./news.php">Новости и акции</a><a class="foot-nav-link" href="#">Услуги</a><a class="foot-nav-link" href="./contacts.php">Контакты</a><a class="foot-nav-link" href="./about.php">О компании</a></nav>
					</div>
					<div class="foot-col foot-prod-col">
						<button class="foot-col-button" data-click-action="front:asideShow"><span class="foot-subtitle">Продукты</span><span></span></button>
						<nav class="foot-nav foot-products"><a class="foot-nav-link" href="#">Вентиляция</a><a class="foot-nav-link" href="#">Лазерная резка</a><a class="foot-nav-link" href="#">Противопожарное оборудование</a><a class="foot-nav-link" href="#">Металлоизделия</a><a class="foot-nav-link" href="#">Эксклюзив</a></nav>
					</div>
				...
				<div class="foot-priv">
					<div class="section"><span class="priv-first">Официальный сайт<strong>ТОО "Лека"</strong>© 1989 - 2021</span><a class="priv-link" href="./privacy.php">Privacy Policy</a>
